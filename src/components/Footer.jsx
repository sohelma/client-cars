      ...
      <div className="max-w-7xl mx-auto px-6 
        ...
        <div className="md:max-w-xs flex flex-col space-y-3">
          ...
          >
            ...
            <span>01 Motijheel C/A, Dhaka</span>
          </Link>
        ...
        <div className="md:max-w-xs flex flex-col space-y-4">
          ...
          <Link
            to="/x"
            className="flex items-center gap-3 group hover:text-sky-400 transition"
          >
            <div className="w-10 h-10 flex items-center justify-center bg-black rounded-full border border-gray-500 group-hover:bg-gray-800 transition-all">
              <span className="text-white font-bold text-lg">X</span>
            </div>
            <span className="text-gray-300 group-hover:text-sky-400 transition">
              X
            </span>
          </Link>
          ...
          <Link
            to="/linkedin"
            className="flex items-center gap-3 group hover:text-blue-500 transition"
          >
          ...
          >
            ...
            <span className="text-gray-300 group-hover:text-pink-400 transition">
              Instagram
            </span>
          </Link>
        </div>
